...
#define STRING_CONFIG_H_AUTHOR "(Elis, GraberElis)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "3D Elis"
...
#define Z_SERVO_ANGLES { 120, 20 } // Z Servo Deploy and Stow angles
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, 5, -16.85 }
